	...
	public class SharedMethods
	{
		...
		public Dictionary<Guid, string> GetScanNames(List<Guid> scanners)
		{
			...
			foreach (var scanner in scanners)
			{
				...
				engine.GenerateInformation("scanner instance section count: " + scannerInstance.Sections.Count);
				foreach (var section in scannerInstance.Sections)
				{
                    ...
                    engine.GenerateInformation("scanner instance section name: " + sectionDefinition.GetName());
                    ...
                    engine.GenerateInformation("scanner name: " + scanName);
